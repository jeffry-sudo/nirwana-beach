...
<html>
  ...
  <body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
                    ...
                    <?php foreach ($keluar as $row) { ?>
                      <tr>
                        ...
                        <td><a href="javascript:void(0)" 
                              onclick="bukaPopup('<?php echo base_url('keluar/cetakstruk/'.$row['kd_keluar']) ?>')">
                                <i class="fa fa-barcode"></i></td>
                      </tr>
                    <?php } ?>
                    </tfoot>
                    </table>
      ...
      <script>
        $(function () {
          $('#example1').DataTable().destroy(); // Hancurkan inisialisasi sebelumnya jika ada
          $('#example1').DataTable({
            "paging": true,
            "lengthChange": false,
            "searching": false,
