...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url('home') ?>" class="brand-link">
      <img src="<?php echo base_url();?>assets/img/LogoMahada.png"
           alt="Parkir"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">NirwanaParking</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url('laporan/parkir_masuk') ?>" class="nav-link">
              <i class="nav-icon fa fa-fa fa-arrow-circle-o-left  "></i>
              <p>Laporan Parkir Masuk</p>
            </a>
          </li>
          <?php endif; ?>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo base_url('laporan/bendahara') ?>" class="nav-link">
                      <i class="fa fa-circle-o nav-icon"></i>
                      <p>Bendahara</p>
                    </a>
                  </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo base_url('laporan/dashboard_petugas_parkir') ?>" class="nav-link">
                      <i class="fa fa-circle-o nav-icon"></i>
                      <p>Laporan Petugas Parkir</p>
                    </a>
                  </li>
                </ul>
