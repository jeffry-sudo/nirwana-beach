            ...
            <div class="card-body">
              ...
              <?php foreach ($jenis as $row) { ?>
                <tr>
                  ...
                  <td align="center"><a href="<?php echo base_url('jeniskendaraan/view/'.$row['kd_kendaraan']) ?>" class="fa fa-edit"></a> | <a href="<?php echo base_url('jeniskendaraan/delete/'.$row['kd_kendaraan']) ?>"><i class="fa fa-trash"></i></a></td>
                </tr>
              <?php } ?>
                </tfoot>
              </table>
